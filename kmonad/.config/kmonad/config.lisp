...
echo 'KERNEL=="uinput", MODE="0660", GROUP="uinput", OPTIONS+="static_node=uinput"' | sudo tee /etc/udev/rules.d/01-uinput.rules
...
kmonad ~/.config/kmonad/config.file
...
#| --------------------------------------------------------------------------
  ...
  - block comments between: hash-pipe and pipe-hash
...
(defcfg
  ;; For Linux
  input  (device-file "/dev/input/by-id/usb-0c45_Wired_Keyboard_Mouse_Combo-event-kbd")
...
;; layers
(defalias
  navs (layer-toggle navigation)
  norm (layer-switch normal)
  base (layer-switch base)
  ;; syms (layer-toggle symbols)
  ;; nums (layer-toggle numbers)
  )

;; keys
(defalias
  nav (tap-hold 500 kprt @navs) ;; keypad return to self and navigation layer
  cap (tap-hold 200 esc lctl) ;; capslock to escape and C
  )
...
(deflayer normal
  ...
  _    _    _    _    _    _    _    _    _    _    _    _    _    _  #||# _    _    _ #||# _    _    _    _
  _    _    _    _    _    _    _    _    _    _    _    _    _       #||#             #||# _    _    _
  _    _    _    _    _    _    _    _    _    _    _    _            #||#      _      #||# _    _    _   @nav
  _    _    _              _              _    _    _    _            #||# _    _    _ #||# _    _
  )
...
(deflayer navigation
  ...
  _    _    _    _    _    _    _    _    _    _    _    _    _    _  #||# _    _    _ #||# _    _    _    _
  _    _    _    _    _    _    _    _    _    _    _    _    _       #||#             #||# _    _    _
  _    _    _    _    _    _    _    _    _    _    _    _            #||#      _      #||# @base _   _    @nav
  _    _    _              _              _    _    _    _            #||# _    _    _ #||# @norm _
  )
...
(deflayer base
  ...
  _    _    _    _    _    _    _    _    _    _    _    _    _    _  #||# _    _    _ #||# _    _    _    _
  @cap _    _    _    _    _    _    _    _    _    _    _    _       #||#             #||# _    _    _
  _    _    _    _    _    _    _    _    _    _    _    _            #||#      _      #||# _    _    _   @nav
  _    _    _              _              _    _    _    _            #||# _    _    _ #||# _    _
  )
...
;;   _    +'   +~   +`   +^   _    _    _    _    _    _    _    _
;;   _    +"   +,   _    _    _    _    _    _    _    _    _ ;; single " breaks following syntax highlights
;;   _    _    _              _              _    _    _    _)
